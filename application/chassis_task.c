...
static void army_outpost(chassis_move_t *army_outpost);
...
/**
  ...
  */
/**
 * @brief Initialize chassis control data 
 * 
 * This function initializes the chassis motion control data structure 
 * chassis_move_t. It sets the initial chassis mode, gets pointers to 
 * remote control, INS angles, gimbal motors and chassis motors. 
 * It initializes the PID controllers for motor speed and chassis angle.
 * It also initializes max speeds and low pass filters for smoother control.
*/
static void chassis_init(chassis_move_t *chassis_move_init)
{
